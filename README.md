...
- **☕ [Java Spring Boot Service](sync-bridge-java/README.md)** (`sync-bridge-java`): Core API built using Spring Boot, Hibernate, and GraphQL, providing logging and database transaction monitoring.
- **📦 [NestJS Service](sync-bridge-nestjs/README.md)** (`sync-bridge-nestjs`): Node.js synchronization engine built on NestJS, TypeORM, and Apollo GraphQL.
