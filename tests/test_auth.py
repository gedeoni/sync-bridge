...
class AuthTests(TestCase):
    ...
    def test_post_sync_no_auth(self):
        ...
        response = self.client.post('/api/v1/sync', {"model": "customers", "data": []}, format='json')
    ...
    def test_post_sync_valid_auth(self):
        ...
        response = self.client.post('/api/v1/sync', {"model": "customers", "data": [{"email": "t@t.com", "first_name": "A", "last_name": "B"}]}, format='json')
        self.assertNotEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
